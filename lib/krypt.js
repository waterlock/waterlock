...
/**
 * Used to generate an API key
 * @return {string} a randomly generated api key
 */
Krypt.prototype.generateApiKey = function(){
    var str = this.random(10);
    return this.sha256(str);
}

/**
 * TODO find a better way to generate one time tokens
 * Returns a one time token
 * @return {string} the one time token
 */
Krypt.prototype.generateToken = function(){
    var str = this.random(10);
    return this.sha256(str);   
}