...
AuthEvent.prototype.findOrCreate = function(criteria, attributes, user, cb){
  if(typeof user !== 'undefined'){
    this._attachToUser(criteria, attributes, user, cb);
  }else{
    this._createUser(criteria, attributes, cb);
  }
};

AuthEvent.prototype._attachToUser = function(criteria, attributes, user, cb){
  var self = this;
...
AuthEvent.prototype._createUser = function(criteria, attributes, cb){
  var self = this;
